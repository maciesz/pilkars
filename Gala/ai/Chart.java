...
import static ai.CompVsPlayerChart.DIRECTIONS;
import static ai.CompVsPlayerChart.X_COORDS;
import static ai.CompVsPlayerChart.Y_COORDS;
...
{  
    ...
    public int computeHash(final int lhs, final int rhs)
    {
        ...
        return Integer.min(lhs, rhs) * MULTIPLIER + Integer.max(lhs, rhs);
    }
